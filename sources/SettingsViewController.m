...
- (NSString *)subtitleForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == DeArrowFilteringRowEnabled)
        return DeArrowLocalized(@"ENABLE_DEARROW_DETAIL",
                                @"Use community-submitted titles and thumbnails");
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
             ...
             indexPath.row == DeArrowFilteringRowTitle)
    {
        ...
        cell.detailTextLabel.text = [NSString
            stringWithFormat:@"%@ · %@", [self subtitleForRowAtIndexPath:indexPath], value];
...
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://ko-fi.com/castdrian"]
                                       options:@{}
...
- (void)presentTitlePickerFromCell:(UITableViewCell *)cell
{
    UIAlertController  *controller = [UIAlertController
        alertControllerWithTitle:DeArrowLocalized(@"PREFERRED_TITLE", @"Preferred title")
                         message:nil
                  preferredStyle:UIAlertControllerStyleActionSheet];
    __weak typeof(self) weakSelf   = self;
    [controller addAction:[UIAlertAction
                              actionWithTitle:DeArrowLocalized(@"DEARROW", @"DeArrow")
    ...
    [controller addAction:[UIAlertAction
                              actionWithTitle:DeArrowLocalized(@"ORIGINAL", @"Original")
                                        style:UIAlertActionStyleDefault
                                      handler:^(__unused UIAlertAction *action) {
                                          [DeArrowPreferences sharedPreferences].titlePreference =
...
- (void)openChangelog
{
    ...
    UINavigationController         *navigationController =
        [[UINavigationController alloc] initWithRootViewController:changelog];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.section == DeArrowSettingsSectionCache)
    {
        ...
        UIAlertController *alert = [UIAlertController
            alertControllerWithTitle:DeArrowLocalized(@"CACHE_CLEARED", @"Cache cleared")
                             message:nil
                      preferredStyle:UIAlertControllerStyleAlert];
        [alert addAction:[UIAlertAction actionWithTitle:DeArrowLocalized(@"OK", @"OK")
                                                  style:UIAlertActionStyleDefault
                                                handler:nil]];
